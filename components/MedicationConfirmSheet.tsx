...
export function MedicationConfirmSheet({ item, visible, isLoading, onConfirm, onDismiss }: Props) {
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.sheet}>
            ...
            <Text style={styles.title}>Record Medication</Text>
            {item && (
              <>
            ...
            <TextInput
              ...
              placeholder="e.g. partial dose, refused..."
            ...
            >
              <Text style={styles.confirmBtnText}>
                {isLoading ? 'Recording...' : 'Mark as Given'}
              </Text>
            </Pressable>
